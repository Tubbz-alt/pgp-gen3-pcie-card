...
create_clock -name pgpGtClk   -period 8.402 [get_pins {PgpCardG3Core_Inst/PgpCore_Inst/PgpClk_Inst/U_MMCM/OutBufgGen.ClkOutGen[0].U_Bufg/O}]
create_clock -name pgpTxClk   -period 8.402 [get_pins {PgpCardG3Core_Inst/PgpCore_Inst/PgpClk_Inst/U_MMCM/OutBufgGen.ClkOutGen[1].U_Bufg/O}]
