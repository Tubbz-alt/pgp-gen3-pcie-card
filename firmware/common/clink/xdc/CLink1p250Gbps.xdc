...
create_clock -name pgpGtClk  -period 16.000 [get_pins {CLinkCore_Inst/PgpClk_Inst/U_MMCM/OutBufgGen.ClkOutGen[0].U_Bufg/O}]
create_clock -name pgpTxClk  -period 16.000 [get_pins {CLinkCore_Inst/PgpClk_Inst/U_MMCM/OutBufgGen.ClkOutGen[1].U_Bufg/O}]
