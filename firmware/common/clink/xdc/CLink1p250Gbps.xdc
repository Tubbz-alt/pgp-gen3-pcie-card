...
create_clock -name pgpGtClk  -period 16.000 [get_pins {CLinkCore_Inst/ClClk_Inst/U_Bufg/O}]
create_clock -name pgpTxClk  -period 16.000 [get_pins {CLinkCore_Inst/ClClk_Inst/U_Bufg/O}]
